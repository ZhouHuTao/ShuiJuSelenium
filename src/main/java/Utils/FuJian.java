 ...
 */
public class FuJian {
    public void screenshots(String id,String password) throws Exception {
        ...
        driver.findElement(By.xpath("//*[@id=\"qyLoginForm\"]/ul/li[1]/input")).sendKeys(id);
        driver.findElement(By.xpath("//*[@id=\"qyLoginForm\"]/ul/li[2]/input")).sendKeys(password);
        ...
        FileUtils.copyFile(srcFile,new File("src/main/resources/image/"+id+".jpg"));
        //40秒短信时间控制
        Thread.sleep(40000);
        driver.close();
    }
